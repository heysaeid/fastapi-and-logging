...
from fastapi_and_logging.logging import get_error_logger


def get_error_logger_default_values(request: Request) -> dict:
    scope = request.scope
    return {
    ...
    async def unhandled_exception_handler(
        ...
        get_error_logger(
            ...
            extra_data = {
                ...
                **get_error_logger_default_values(request),
            }
        )
        return JSONResponse(
            status_code = status.HTTP_500_INTERNAL_SERVER_ERROR,
